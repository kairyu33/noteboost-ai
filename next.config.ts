...
const nextConfig: NextConfig = {
  ...
  /**
   * Turbopack Configuration (Experimental in Next.js 16)
   *
   * @description Explicitly set the workspace root to avoid multiple lockfile warnings
   * This ensures Turbopack uses the correct project directory
   *
   * Note: Turbopack root configuration is experimental and may not work in all cases.
